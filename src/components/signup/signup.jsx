...
export default function Signup() {
    ...
    const onSubmit = async (data) => {
        console.log(data);
        let r = await fetch("https://youtube-backend-gilt.vercel.app/api/register/signup", { method: 'POST', headers: { "content-Type": "application/json" }, body: JSON.stringify(data) })
        if (r.redirected) {
