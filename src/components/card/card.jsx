...
export default function Card(address) {
    ...
    const handleVideoLoad = () => {
        ...
        let res = fetch("https://youtube-backend-gilt.vercel.app/api/list/ins", {
            method: "PUT",
    ...
    return (<span className={styles.main}>
        <span style={{ display: "inline-block" }}>
            <img className={styles.image} src={`/api/download/${encodeURIComponent(address.address.thumbnail)}`} width={size} onClick={() => handleVideoLoad(address)} />
